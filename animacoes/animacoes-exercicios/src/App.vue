<template>
	<div id="app" class="container-fluid">
		...
		<hr>
		<b-button @click="exibir2 = !exibir2" variant="primary">Alternar</b-button>
		<transition
			:css="false"
			@before-enter="beforeEnter"
			@enter="enter"
			@after-ender="afterEnter"
		...
		<div class="mb-4">
			...
			<b-button variant="warning" @click="componenteSelecionado = 'AlertaAdvertencia'">Advertencia</b-button>
		</div>
